...
T.ItemDelegate {
    ...
    PlasmaCore.FrameSvgItem {
        ...
        prefix: "hover"
        visible: ((suppressHoverSelection)&&(mouseArea.containsMouse)&&(!hideOnPress))
        anchors.fill: parent
        property bool hideOnPress: false  // on wayland containsMouse returns true after pressed() is emitted and menu is closed. Probably a Qt bug or something 
    }
    ...
    MouseArea {
        ...
        onEntered: {
            howerHighlight.hideOnPress = false;
        ...
        onClicked: if (mouse.button === Qt.LeftButton) {
            howerHighlight.hideOnPress = true;
            root.action.trigger();
